...
@app.route('/writetoex2', methods=['POST'])
def write_to_excel():
    # 获取POST请求中的参数
    ...
    try:
        ...
        if not os.path.exists(ip_excel_file):
            ...
            template_excel_file = os.path.join(current_path, 'ex2Value.xlsx')
...
if __name__ == '__main__':
    server = pywsgi.WSGIServer(('0.0.0.0', 3353), app)
